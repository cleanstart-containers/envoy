...
```bash
docker pull ghcr.io/cleanstart-containers/envoy:envoy
```
```bash
docker pull ghcr.io/cleanstart-containers/envoy:container
```
```bash
docker pull ghcr.io/cleanstart-containers/envoy:enterprise
```
...
```bash
docker run -it --name envoy ghcr.io/cleanstart-containers/envoy:latest
```
...
```bash
docker run -v /app:/app ghcr.io/cleanstart-containers/envoy:latest
```

Port Forwarding Run with custom port mappings

```bash
docker run -p 8080:8080 ghcr.io/cleanstart-containers/envoy:latest
```
